 ...
 */
package jp.co.yahoo.dataplatform.mds.example.blackbox;
...
import jp.co.yahoo.dataplatform.mds.blackbox.TestIntegerPrimitiveColumn;

public class TestExampleIntegerPrimitiveColumn extends TestIntegerPrimitiveColumn{

  @DataProvider(name = "target_class")
  public Object[][] data1() throws IOException{
    return new Object[][] {
      { "jp.co.yahoo.dataplatform.mds.example.binary.SimpleIntegerColumnBinaryMaker" } ,
    };
  }
