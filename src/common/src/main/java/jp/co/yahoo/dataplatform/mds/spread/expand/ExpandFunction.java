...
public class ExpandFunction implements IExpandFunction{
  ...
  public ExpandFunction( final ExpandNode expandNode , final ExpandColumnLink expandColumnLink , final List<String> columnNameList , final List<String> linkColumnNameList ){
