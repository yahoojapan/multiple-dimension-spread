...
public class ByteColumnAnalizeResult implements IColumnAnalizeResult{
  ...
  public ByteColumnAnalizeResult( final String columnName , final int columnSize , final boolean sortFlag , final int nullCount , final int rowCount , final int uniqCount , final byte min , final byte max ){
  ...
  public int getLogicalDataSize(){
    return PrimitiveByteLength.BYTE_LENGTH * rowCount;
  }
