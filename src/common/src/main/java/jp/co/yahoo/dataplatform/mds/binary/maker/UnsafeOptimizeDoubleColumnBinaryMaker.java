...
public class UnsafeOptimizeDoubleColumnBinaryMaker implements IColumnBinaryMaker{
  ...
  public interface IDictionaryMaker{
    ...
    PrimitiveObject[] getDicPrimitiveArray( final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException;
  ...
  public static class DoubleDictionaryMaker implements IDictionaryMaker{
    ...
    @Override
    public PrimitiveObject[] getDicPrimitiveArray( final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException{
  ...
  public void loadInMemoryStorage( final ColumnBinary columnBinary , final IMemoryAllocator allocator ) throws IOException{
    ...
    PrimitiveObject[] dicArray = dicMaker.getDicPrimitiveArray( binary , indexLength , dicLength , order );
