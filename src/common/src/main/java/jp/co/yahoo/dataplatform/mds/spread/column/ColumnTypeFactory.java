...
public final class ColumnTypeFactory{
  ...
  public static int getColumnTypeToJavaPrimitiveByteSize( final ColumnType type , final PrimitiveObject object ) throws IOException{
    return getColumnTypeToPrimitiveByteSize( type , object ) + PrimitiveByteLength.JAVA_OBJECT_LENGTH;
  }

  public static int getColumnTypeToPrimitiveByteSize( final ColumnType type , final PrimitiveObject object ) throws IOException{
    switch( type ){
      case BOOLEAN:
