...
public class ColumnBinaryMakerCustomConfigNode{
  ...
  private final Map<String,ColumnBinaryMakerCustomConfigNode> childConfigNode = new HashMap<String,ColumnBinaryMakerCustomConfigNode>();

  public ColumnBinaryMakerCustomConfigNode( final String currentColumnName , final ColumnBinaryMakerConfig currentConfig ) throws IOException{
    this.currentColumnName = currentColumnName;
    this.currentConfig = currentConfig;
  }

  public ColumnBinaryMakerCustomConfigNode( final ColumnBinaryMakerConfig commonConfig , final IParser jsonParser ) throws IOException{
    ...
    for( int i = 0 ; i < childArrayParser.size() ; i++ ){
      ...
      ColumnBinaryMakerCustomConfigNode childNodeConfig = new ColumnBinaryMakerCustomConfigNode( commonConfig , childParser );
