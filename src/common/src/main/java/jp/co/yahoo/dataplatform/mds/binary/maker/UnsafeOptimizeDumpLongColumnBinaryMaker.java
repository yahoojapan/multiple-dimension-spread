...
public class UnsafeOptimizeDumpLongColumnBinaryMaker implements IColumnBinaryMaker{
  ...
  public interface IBinaryMaker{
    ...
    PrimitiveObject[] getPrimitiveArray( final byte[] buffer , final int start , final int length , final int columnSize , final boolean hasNull , final ByteOrder order ) throws IOException;

    void loadInMemoryStorage( final byte[] buffer , final int start , final int length , final IMemoryAllocator allocator , final byte[] isNullArray , final int size , final boolean hasNull , final ByteOrder order ) throws IOException;
  ...
  public static class ByteBinaryMaker implements IBinaryMaker{
    ...
    @Override
    public PrimitiveObject[] getPrimitiveArray( final byte[] buffer , final int start , final int length , final int columnSize , final boolean hasNull , final ByteOrder order ) throws IOException{
    ...
    @Override
    public void loadInMemoryStorage( final byte[] buffer , final int start , final int length , final IMemoryAllocator allocator , final byte[] isNullArray , final int size , final boolean hasNull , final ByteOrder order ) throws IOException{
      IReadSupporter wrapBuffer = ByteBufferSupporterFactory.createReadSupporter( buffer , start , length , order );
  ...
  public void loadInMemoryStorage( final ColumnBinary columnBinary , final IMemoryAllocator allocator ) throws IOException{
    ...
    binaryMaker.loadInMemoryStorage( binary , isNullLength , binaryLength , allocator , binary , columnBinary.rowCount , hasNull , order );
  ...
  public class DicManager implements IDicManager{
    ...
    public DicManager( final PrimitiveObject[] dicArray , final byte[] nullArray , final boolean hasNull ) throws IOException{
  ...
  public class ColumnManager implements IColumnManager{
    ...
    public ColumnManager( final ColumnBinary columnBinary , final IBinaryMaker binaryMaker , final boolean hasNull , final ByteOrder order , final int rowCount ){
    ...
    public void create() throws IOException{
      ...
      PrimitiveObject[] dicArray = binaryMaker.getPrimitiveArray( binary , isNullLength , binaryLength , columnBinary.rowCount , hasNull , order );
