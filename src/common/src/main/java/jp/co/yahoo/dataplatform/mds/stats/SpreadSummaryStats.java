...
public class SpreadSummaryStats{
  ...
  public String toString(){
    return String.format( "Line count=%d , Average record size=%f , Average record real size=%f , Average record per field=%f , %s" , lineCount , getAverageRecordSize() , getAverageRecordRealSize() , getAverageRecordPerField() , summaryStats.toString() );
  }
