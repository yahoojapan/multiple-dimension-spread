...
public class BytesColumnAnalizeResult implements IColumnAnalizeResult{
  ...
  public BytesColumnAnalizeResult( final String columnName , final int columnSize , final boolean sortFlag , final int nullCount , final int rowCount , final int uniqCount ,  final int totalLogicalDataSize , final int minBytes , final int maxBytes ){
