...
public class ExpandNode {
  ...
  public ExpandNode( final List<String> columnNameList , final List<String> linkColumnNameList ) throws IOException{
  ...
  public ExpandNode( final List<String> columnNameList , final List<String> linkColumnNameList , final int depth ) throws IOException{
  ...
  public int[] setExpandColumn( final IColumn original , final ExpandSpread expandSpread ) throws IOException{
    if( childNode == null ){
      ...
      for( int i = 0 ; i < loopCount ; i++ ){
        ...
        ArrayCell arrayCell = (ArrayCell)( cell );
        for( int childIndex = arrayCell.getStart() ; childIndex < arrayCell.getEnd() ; childIndex++ ){
          while( parentCount < childIndexArray.length && childIndexArray[parentCount] == childIndex ){
