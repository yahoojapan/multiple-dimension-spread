...
public class SequentialStringCellIndex implements ICellIndex{
  ...
  private boolean[] dictionaryString( final Set<String> dictionary , boolean[] filterArray ) throws IOException{
  ...
  private boolean[] compareString( final IStringComparator comparator , boolean[] filterArray ) throws IOException{
    for( int i = 0 ; i < dicManager.getDicSize() ; i++ ){
      PrimitiveObject obj = dicManager.get( i );
  ...
  private boolean[] perfectMatch( final String targetStr , boolean[] filterArray ) throws IOException{
    for( int i = 0 ; i < dicManager.getDicSize() ; i++ ){
      PrimitiveObject obj = dicManager.get( i );
  ...
  private boolean[] partialMatch( final String targetStr , boolean[] filterArray ) throws IOException{
    for( int i = 0 ; i < dicManager.getDicSize() ; i++ ){
      PrimitiveObject obj = dicManager.get( i );
  ...
  private boolean[] forwardMatch( final String targetStr , boolean[] filterArray ) throws IOException{
    for( int i = 0 ; i < dicManager.getDicSize() ; i++ ){
      PrimitiveObject obj = dicManager.get( i );
  ...
  private boolean[] backwardMatch( final String targetStr , boolean[] filterArray ) throws IOException{
    for( int i = 0 ; i < dicManager.getDicSize() ; i++ ){
      PrimitiveObject obj = dicManager.get( i );
  ...
  private boolean[] regexpMatch( final String targetStr , boolean[] filterArray ) throws IOException{
    for( int i = 0 ; i < dicManager.getDicSize() ; i++ ){
      PrimitiveObject obj = dicManager.get( i );
