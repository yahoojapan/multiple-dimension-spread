...
public class UnsafeOptimizeLongColumnBinaryMaker implements IColumnBinaryMaker{
  ...
  public interface IDictionaryMaker{
    ...
    void create( final List<PrimitiveObject> objList , final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException;

    PrimitiveObject[] getDicPrimitiveArray( final int size , final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException;
  ...
  public static class ByteDictionaryMaker implements IDictionaryMaker{
    ...
    @Override
    public void create( final List<PrimitiveObject> objList , final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException{
    ...
    @Override
    public PrimitiveObject[] getDicPrimitiveArray( final int size , final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException{
  ...
  public static class IntDictionaryMaker implements IDictionaryMaker{
    ...
    @Override
    public void create( final List<PrimitiveObject> objList , final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException{
      IWriteSupporter wrapBuffer = converter.toWriteSuppoter( objList.size() , buffer , start , length );
      for( PrimitiveObject obj : objList ){
  ...
  public interface IDictionaryIndexMaker{
    ...
    IntBuffer getIndexIntBuffer( final byte[] buffer , final int start , final int length , final ByteOrder order ) throws IOException;
  ...
  public void loadInMemoryStorage( final ColumnBinary columnBinary , final IMemoryAllocator allocator ) throws IOException{
    ...
    PrimitiveObject[] dicArray = dicMaker.getDicPrimitiveArray( columnBinary.cardinality , binary , indexLength , dicLength , order );
  ...
  public class ColumnManager implements IColumnManager{
    ...
    public ColumnManager( final ColumnBinary columnBinary , final IDictionaryIndexMaker indexMaker , final IDictionaryMaker dicMaker , final ByteOrder order ){
