...
public final class CollectionUtils{
  ...
  public static List<Integer> intersectionFromSortedCollection( final List<Integer> list1 , final List<Integer> list2 ){
  ...
  public static List<Integer> unionFromSortedCollection( final List<Integer> list1 , final List<Integer> list2 ){
    List<Integer> result = new ArrayList<Integer>();
    List<Integer> loopTarget;
    List<Integer> compreTarget;
    if( list1.size() < list2.size() ){
