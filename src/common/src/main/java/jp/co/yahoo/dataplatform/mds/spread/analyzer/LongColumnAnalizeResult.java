...
public class LongColumnAnalizeResult implements IColumnAnalizeResult{
  ...
  public LongColumnAnalizeResult( final String columnName , final int columnSize , final boolean sortFlag , final int nullCount , final int rowCount , final int uniqCount , final long min , final long max ){
  ...
  public int getLogicalDataSize(){
    return PrimitiveByteLength.LONG_LENGTH * rowCount;
  }
