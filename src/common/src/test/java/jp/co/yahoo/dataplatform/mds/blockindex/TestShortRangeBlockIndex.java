...
public class TestShortRangeBlockIndex{
  ...
  public Object[][] data1() {
    return new Object[][] {
      ...
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)10 ) , true , new ShortObj( (short)10 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)5 ) , true , new ShortObj( (short)15 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)20 ) , true , new ShortObj( (short)21 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)15 ) , true , new ShortObj( (short)25 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)10 ) , true , new ShortObj( (short)20 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)10 ) , true , new ShortObj( (short)10 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)20 ) , true , new ShortObj( (short)20 ) , true ) , true },
      { new ShortRangeBlockIndex( (short)10 , (short)20 ) , new NumberRangeFilter( true , new ShortObj( (short)15 ) , true , new ShortObj( (short)16 ) , true ) , true },
