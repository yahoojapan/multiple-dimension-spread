...
public class TestDumpUnionColumnBinaryMaker {
  ...
  public void T_toBinary_1() throws IOException{
    ...
    //System.err.println( decodeColumn.get(0).getRow().getClass().getName() );
    //assertTrue( decodeColumn.get(0).getRow() instanceof StringObj );
    assertTrue( decodeColumn.get(1).getRow() instanceof IntegerObj );
