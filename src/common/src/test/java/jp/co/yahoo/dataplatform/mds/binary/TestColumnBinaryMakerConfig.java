...
public class TestColumnBinaryMakerConfig{
  ...
  public Object[][] D_T_addRowNotException(){
    return new Object[][]{
      ...
      { ColumnType.BYTE , OptimizeLongColumnBinaryMaker.class.getName() },
      ...
      { ColumnType.INTEGER , OptimizeLongColumnBinaryMaker.class.getName() },
      { ColumnType.LONG , OptimizeLongColumnBinaryMaker.class.getName() },
      { ColumnType.SHORT , OptimizeLongColumnBinaryMaker.class.getName() },
