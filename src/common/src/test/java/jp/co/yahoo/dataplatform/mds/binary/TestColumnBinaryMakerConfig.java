...
public class TestColumnBinaryMakerConfig{
  ...
  public Object[][] D_T_addRowNotException(){
    return new Object[][]{
      ...
      { ColumnType.BYTE , OptimizeDumpLongColumnBinaryMaker.class.getName() },
      ...
      { ColumnType.INTEGER , OptimizeDumpLongColumnBinaryMaker.class.getName() },
      { ColumnType.LONG , OptimizeDumpLongColumnBinaryMaker.class.getName() },
      { ColumnType.SHORT , OptimizeDumpLongColumnBinaryMaker.class.getName() },
      { ColumnType.STRING , OptimizeDumpStringColumnBinaryMaker.class.getName() },
