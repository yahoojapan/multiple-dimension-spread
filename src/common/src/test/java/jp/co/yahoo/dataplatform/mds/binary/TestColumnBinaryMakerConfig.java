...
public class TestColumnBinaryMakerConfig{
  ...
  public Object[][] D_T_addRowNotException(){
    return new Object[][]{
      ...
      { ColumnType.BYTE , UnsafeOptimizeLongColumnBinaryMaker.class.getName() },
      ...
      { ColumnType.INTEGER , UnsafeOptimizeLongColumnBinaryMaker.class.getName() },
      { ColumnType.LONG , UnsafeOptimizeLongColumnBinaryMaker.class.getName() },
      { ColumnType.SHORT , UnsafeOptimizeLongColumnBinaryMaker.class.getName() },
