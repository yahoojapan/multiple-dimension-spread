...
public class TestByteRangeBlockIndex{
  ...
  public Object[][] data1() {
    return new Object[][] {
      ...
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)10 ) , true , new ByteObj( (byte)10 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)5 ) , true , new ByteObj( (byte)15 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)20 ) , true , new ByteObj( (byte)21 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)15 ) , true , new ByteObj( (byte)25 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)10 ) , true , new ByteObj( (byte)20 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)10 ) , true , new ByteObj( (byte)10 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)20 ) , true , new ByteObj( (byte)20 ) , true ) , true },
      { new ByteRangeBlockIndex( (byte)10 , (byte)20 ) , new NumberRangeFilter( true , new ByteObj( (byte)15 ) , true , new ByteObj( (byte)16 ) , true ) , true },
