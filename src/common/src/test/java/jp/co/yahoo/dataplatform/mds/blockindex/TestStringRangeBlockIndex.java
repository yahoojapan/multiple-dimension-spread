...
public class TestStringRangeBlockIndex{
  ...
  public Object[][] data1() {
    return new Object[][] {
      ...
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "10" , true , "10" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "05" , true , "15" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "20" , true , "21" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "15" , true , "25" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "10" , true , "20" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "10" , true , "10" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "20" , true , "20" , true , true ) , true },
      { new StringRangeBlockIndex( "10" , "20" ) , new RangeStringCompareFilter( "15" , true , "16" , true , true ) , true },
