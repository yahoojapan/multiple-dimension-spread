...
public class TestRangeIndexFloatColumnBinaryMaker {
  ...
  public void T_toBinary_1() throws IOException{
    ...
    IColumnBinaryMaker maker = new RangeIndexFloatColumnBinaryMaker();
    ...
    assertEquals( (float)0.2 , ( (PrimitiveObject)( decodeColumn.get(1).getRow() ) ).getFloat() );
