...
public class MDSSchemaStreamWriter implements IStreamWriter{

  private final MDSRecordWriter writer;

  public MDSSchemaStreamWriter( final OutputStream out , final Configuration config ) throws IOException{
