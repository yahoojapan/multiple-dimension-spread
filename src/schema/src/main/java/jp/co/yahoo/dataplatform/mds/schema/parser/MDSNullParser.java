...
public final class MDSNullParser implements ISettableIndexParser {

  private static final MDSNullParser PARSER = new MDSNullParser();

  private MDSNullParser(){}
